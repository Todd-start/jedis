...
public class TechwolfJedisCluster extends TechwolfBinaryJedisCluster implements JedisCommands,
    ...
    public TechwolfJedisCluster(HostAndPort node, String password, String clientName, final GenericObjectPoolConfig poolConfig) {
    ...
    public ScanResult<String> scan(final String cursor, final ScanParams params) {
        ...
        if (params == null || (matchPattern = params.match()) == null || matchPattern.isEmpty()) {
            throw new IllegalArgumentException(TechwolfJedisCluster.class.getSimpleName() + " only supports SCAN commands with non-empty MATCH patterns");
        }
        ...
        if (JedisClusterHashTagUtil.isClusterCompliantMatchPattern(matchPattern)) {
            ...
            throw new IllegalArgumentException(TechwolfJedisCluster.class.getSimpleName() + " only supports SCAN commands with MATCH patterns containing hash-tags ( curly-brackets enclosed strings )");
        }
    }
